...
--
-- Host: localhost    Database: chat_api
-- ------------------------------------------------------
...
CREATE TABLE `messages` (
  ...
  KEY `idx_messages_users_time` (`sender_user_id`,`receiver_user_id`,`created_at`),
  CONSTRAINT `messages_receiver_user_id_foreign` FOREIGN KEY (`receiver_user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
...
-- Dump completed on 2025-01-17 16:44:16
